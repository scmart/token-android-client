...
import com.tokenbrowser.crypto.signal.store.SignalPreKeyStore;
...
public class PreKeyUtil {
    ...
    private static File getPreKeysDirectory(Context context) {
        return getKeysDirectory(context, SignalPreKeyStore.PREKEY_DIRECTORY);
    }

    private static File getSignedPreKeysDirectory(Context context) {
        return getKeysDirectory(context, SignalPreKeyStore.SIGNED_PREKEY_DIRECTORY);
    }

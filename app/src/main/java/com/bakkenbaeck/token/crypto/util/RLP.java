...
import static com.bakkenbaeck.token.crypto.util.ByteUtil.byteArrayToInt;
import static com.bakkenbaeck.token.crypto.util.ByteUtil.intToBytesNoLeadZeroes;
import static com.bakkenbaeck.token.crypto.util.ByteUtil.isNullOrZeroArray;
import static com.bakkenbaeck.token.crypto.util.ByteUtil.isSingleZero;
